...
public class VerificationAPI {
    ...
    static {
        REGISTRY.register(new ApiMethodConfig("/verify/email/", ApiMethodType.POST,
                ...
                (DataConverter<String, StartVerificationResponse>) input -> StartVerificationResponse.success(), WorkflowEngine.temporal));
        REGISTRY.register(new ApiMethodConfig("/verify/email/otp", ApiMethodType.POST,
                ...
                (DataConverter<String, VerifyOtpResponse>) input -> VerifyOtpResponse.success(), WorkflowEngine.temporal));
        ...
        REGISTRY.register(new ApiMethodConfig("/verify/email/v2", ApiMethodType.POST,
                ...
                (DataConverter<String, StartVerificationResponse>) input -> StartVerificationResponse.success(), WorkflowEngine.camunda));
        REGISTRY.register(new ApiMethodConfig("/verify/email/otp/v2", ApiMethodType.POST,
                ...
                (DataConverter<String, VerifyOtpResponse>) input -> VerifyOtpResponse.success(), WorkflowEngine.camunda));
    ...
    public StartVerificationResponse startVerification(StartVerificationRequest request) {
        ...
        String runId = temporalEngineProcessor.startWorkflow(request.userId(), config.getWorkflowIdentifier(), config.getRequestConverter().convert(request));
    ...
    public VerifyOtpResponse verifyOtp(VerifyOtpRequest request) {
        ...
        temporalEngineProcessor.signalWorkflow(request.userId(), config.getWorkflowIdentifier(), config.getMethodName(), runId,
